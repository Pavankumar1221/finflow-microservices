...
public class OpenApiConfig {
    ...
    public OpenAPI applicationServiceOpenAPI() {
        ...
        // to this service. All application endpoints are at /applications/** on the gateway.
        ...
        return new OpenAPI()
                ...
                .info(new Info()
                        ...
                        .version("1.0.0")
                        .description("Loan Application lifecycle management: submission, tracking and status updates"))
